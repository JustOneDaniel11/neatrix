        ...
        <div className="border-t border-background/20 pt-6 md:pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-3 md:space-y-0">
            ...
            <div className="flex space-x-4 md:space-x-6">
              <Link to="/privacy" className="text-background/60 hover:text-primary transition-colors text-sm md:text-base">
                Privacy Policy
              </Link>
              <Link to="/terms" className="text-background/60 hover:text-primary transition-colors text-sm md:text-base">
                Terms of Service
              </Link>
            </div>
          </div>
