        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-3">
          <div className="flex-1 min-w-0">
            <input
              ...
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-base min-h-[48px] touch-manipulation"
            />
          </div>
          <button
            onClick={handleTrackOrder}
            className="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 active:bg-blue-800 transition-colors duration-300 flex items-center justify-center font-medium text-base min-h-[48px] touch-manipulation whitespace-nowrap sm:flex-shrink-0 w-full sm:w-auto"
          >
