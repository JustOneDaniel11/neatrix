        ...
        <div className="p-4 md:p-6 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-2">
            <input
              ...
              className="flex-1 px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-500 text-base transition-all duration-200 min-w-0 min-h-[48px] touch-manipulation"
            />
            <button
              onClick={handleTrackNewOrder}
              disabled={!trackingCode.trim() || isLoadingTrackingCode}
              className="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 text-base font-medium shadow-sm hover:shadow-md active:scale-95 whitespace-nowrap min-h-[48px] touch-manipulation flex items-center justify-center sm:flex-shrink-0 w-full sm:w-auto"
            >
        ...
        <div className="flex-1 overflow-y-auto">
          {bookingsLoading ? (
            <div className="flex items-center justify-center py-12">
              <CleaningLoader size="md" text="Loading orders..." />
            </div>
