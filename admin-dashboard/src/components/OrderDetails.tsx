    ...
    return (
      <div className="h-full flex items-center justify-center bg-gray-50 dark:bg-gray-800 p-4">
        <div className="text-center">
          <Package className="w-12 h-12 sm:w-16 sm:h-16 text-gray-400 dark:text-gray-600 mx-auto mb-4" />
          <h3 className="text-base sm:text-xl font-medium text-gray-900 dark:text-white mb-2">Select an Order</h3>
          <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400">Choose an order from the inbox to view and update its tracking progress.</p>
        </div>
      </div>
    );
  }
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">#{order.id.slice(-6).toUpperCase()}</p>
            </div>
          </div>
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="grid grid-cols-1 gap-3 sm:gap-4">
              <div>
                <label className="block text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-1">Customer Name</label>
                <div className="px-2 sm:px-3 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg text-xs sm:text-sm text-gray-900 dark:text-white break-words">
                  {order.customer_name || 'Unknown User'}
                </div>
              </div>
              
              <div>
                <label className="block text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-1">Email</label>
                <div className="px-2 sm:px-3 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg text-xs sm:text-sm text-gray-900 dark:text-white break-words flex items-center">
                  <Mail className="w-3 h-3 sm:w-4 sm:h-4 mr-2 text-gray-500 dark:text-gray-400" />
              ...
              {(order.users?.phone || order.phone) && (
                <div>
                  <label className="block text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-1">Phone Number</label>
                  <div className="px-2 sm:px-3 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg text-xs sm:text-sm text-gray-900 dark:text-white break-words flex items-center">
                    <svg className="w-3 h-3 sm:w-4 sm:h-4 mr-2 text-gray-500 dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {order.address && (
                <div>
                  <label className="block text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-1">Address</label>
                  <div className="px-2 sm:px-3 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg text-xs sm:text-sm text-gray-900 dark:text-white break-words flex items-start">
                    <MapPin className="w-3 h-3 sm:w-4 sm:h-4 mr-2 mt-0.5 text-gray-500 dark:text-gray-400 flex-shrink-0" />
              ...
              <div>
                <label className="block text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-1">Order Date</label>
                <div className="px-2 sm:px-3 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg text-xs sm:text-sm text-gray-900 dark:text-white break-words flex items-center">
                  <Clock className="w-3 h-3 sm:w-4 sm:h-4 mr-2 text-gray-500 dark:text-gray-400" />
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 gap-4">
              <div>
                ...
                <div className="px-3 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg text-sm text-gray-900 dark:text-white">
                  {order.service_name}
                </div>
              </div>

              <div>
                <label className="block text-sm text-gray-600 dark:text-gray-400 mb-1">Delivery Method</label>
                <div className="flex items-center">
                  {isEditingDelivery ? (
                    <select
                      value={tempDeliveryType}
                      onChange={(e) => setTempDeliveryType(e.target.value)}
                      className="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent text-sm dark:bg-gray-700 dark:text-white"
                    >
                    ...
                    <>
                      <div className="flex-1 px-3 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg text-sm text-gray-900 dark:text-white flex items-center">
                      ...
                      <button
                        ...
                        className="ml-2 p-2 text-gray-500 dark:text-gray-400 hover:text-purple-600 hover:bg-purple-50 dark:hover:bg-purple-900/20 rounded-lg transition-colors"
                      >
              ...
              <div>
                ...
                <div className="flex items-center">
                  {isEditingPrice ? (
                    ...
                    <>
                      <div className="flex-1 px-3 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg text-sm text-gray-900 dark:text-white font-medium">
          ...
          <div className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-xl p-3 sm:p-6 border border-purple-100 dark:border-purple-800 mt-4 sm:mt-8">
            ...
            <div className="mb-6 sm:mb-8 lg:mb-10">
              ...
              <div className="mb-4 sm:mb-6 lg:mb-8">
                ...
                <div className="flex justify-between text-xs sm:text-sm lg:text-base text-gray-500 dark:text-gray-400 mt-2 lg:mt-3">
                  <span>Started</span>
                  ...
                  return (
                    <div key={stage} className="flex items-center space-x-3 sm:space-x-4 lg:space-x-6">
                      ...
                      <div className={`
                        ...
                        ${isCompleted 
                          ...
                          : isCurrent 
                            ...
                            : 'bg-gray-100 dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-400 dark:text-gray-500 lg:bg-gray-50 dark:lg:bg-gray-700'
                        }
                      `}>
                        {isCompleted ? (
                      ...
                      <div className="flex-shrink-0">
                        {isCurrent && (
                          <div className="bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 text-xs lg:text-sm font-medium px-2 py-1 lg:px-4 lg:py-2 rounded-full lg:rounded-lg">
                        ...
                        {isCompleted && (
                          <div className="bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 text-xs lg:text-sm font-medium px-2 py-1 lg:px-4 lg:py-2 rounded-full lg:rounded-lg">
                        ...
                        {isUpcoming && (
                          <div className="bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400 text-xs lg:text-sm font-medium px-2 py-1 lg:px-4 lg:py-2 rounded-full lg:rounded-lg">
              ...
              <div className="hidden lg:block mt-8 p-4 bg-gradient-to-r from-purple-50 to-green-50 dark:from-purple-900/20 dark:to-green-900/20 rounded-lg border border-purple-200 dark:border-purple-700">
                <div className="flex items-center justify-between">
